...
Web app personale in italiano per organizzare piani alimentari. Frontend statico, senza account o backend, predisposto per GitHub Pages. La versione **0.6** comprende editor diete, pazienti, calcolo energetico multi-metodo, generazione kcal/macro personalizzata, misurazioni, appuntamenti, documenti PDF e trasferimento dei dati tramite file. “Spazio personale” apre **Studio e file**.
