...
export function DietGenerator() {
  ...
  try { if (patient) energyTarget = resolveEnergyTarget(patient, measurements.filter(m => m.patientId === patient.id)) } catch { /* The patient form explains missing inputs. */ }
