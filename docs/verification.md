# Verifica di GelatoNutriente v0.5
...
| `npm test` | 88 test passati in 6 file |
| Build | `dist/` generata; avviso non bloccante sul bundle principale di circa 596 kB (178 kB gzip). Grafici e PDF sono caricati su richiesta |
...
- Percentuali energetiche 4/4/9; confronto fra 9 metodi energetici, PAL, correzione e override manuale; sospensione per dati o contesti non applicabili e validazione degli obiettivi macro al 100%.
...
Le modifiche sono disponibili nella cartella locale. Nessun commit, push o deploy è stato eseguito per la versione 0.5.
