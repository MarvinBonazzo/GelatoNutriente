# Verifica di GelatoNutriente v0.7
...
| `npm test` | 96 test passati in 6 file |
| Build | `dist/` generata; avviso non bloccante sul bundle principale di circa 611 kB (183 kB gzip). Grafici e PDF sono caricati su richiesta |
...
- Percentuali energetiche 4/4/9; cinque profili macro modificabili; ottimizzazione delle porzioni verso kcal e macro entro tolleranza; confronto fra 9 metodi energetici, PAL, strategie obiettivo percentuale/scarto fisso/ritmo settimanale/nessuna variazione, correzione professionale e override manuale.
...
Le modifiche sono disponibili nella cartella locale. Nessun commit, push o deploy è stato eseguito per la versione 0.7.
